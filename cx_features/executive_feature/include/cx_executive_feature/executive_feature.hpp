...
#ifndef CX_FEATURES__EXECUTIVEFEATURE_HPP_
#define CX_FEATURES__EXECUTIVEFEATURE_HPP_
...
class ExecutiveFeature : public ClipsFeature {
public:
  ExecutiveFeature();
  ~ExecutiveFeature();
...
#endif // !CX_FEATURES__EXECUTIVEFEATURE_HPP_
