...
std::string ProtobufFeature::getFeatureName() const {
...
bool ProtobufFeature::clips_context_init(
...
bool ProtobufFeature::clips_context_destroyed(const std::string &env_name) {
