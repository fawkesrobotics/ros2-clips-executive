 ...
 */
EffectToCLIPSFactVisitor::EffectToCLIPSFactVisitor(const string &pddl_operator,
                                                   bool positive)
 ...
 */
vector<string> EffectToCLIPSFactVisitor::operator()(Atom &a) const {
 ...
 */
vector<string> EffectToCLIPSFactVisitor::operator()(Predicate &p) const {
  vector<string> res;
  if (p.function == "and") {
