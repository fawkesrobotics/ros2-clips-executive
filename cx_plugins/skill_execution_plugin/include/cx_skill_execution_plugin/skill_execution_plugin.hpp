...
#ifndef CX_PLUGINS__SKILLEXECUTIONPLUGIN_HPP_
#define CX_PLUGINS__SKILLEXECUTIONPLUGIN_HPP_
...
class SkillExecutionPlugin : public ClipsPlugin {
public:
...
#endif // !CX_PLUGINS__SKILLEXECUTIONPLUGIN_HPP_
