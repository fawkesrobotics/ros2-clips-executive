...
(defrule wm-sync-config-remap-fact-id-prefix
	(executive-init)
  ?cf <- (confval (path ?path&:(eq (str-cat "/clips-executive/wm-remap/facts/id-prefix") ?path))
...
(defrule wm-sync-config-remap-fact-name-id
	(executive-init)
  ?cf <- (confval (path ?path&:(str-prefix (str-cat "/clips-executive/wm-remap/facts/name-id/") ?path))
									(type STRING) (value ?key-path) (is-list FALSE))
	=>
	(retract ?cf)
  (bind ?prefix (str-cat "/clips-executive/wm-remap/facts/name-id/"))
...
(defrule wm-sync-config-remap-object-id-prefix
	(executive-init)
  ?cf <- (confval (path ?path&:(eq (str-cat "/clips-executive/wm-remap/objects/id-prefix") ?path))
									(type STRING) (is-list TRUE) (list-value $?id-prefixes))
	=>
	(retract ?cf)
...
(defrule wm-sync-config-remap-object-name-id
	(executive-init)
  ?cf <- (confval (path ?path&:(str-prefix (str-cat "/clips-executive/wm-remap/objects/name-id/") ?path))
									(type STRING) (value ?id) (is-list FALSE))
	=>
	(retract ?cf)
  (bind ?prefix (str-cat "/clips-executive/wm-remap/objects/name-id/"))
